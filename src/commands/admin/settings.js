...
module.exports = class SettingsCommand extends Command {
  ...
  run(message, args) {
    ...
    const appealsCategory = message.guild.channels.cache.get(row.appealsCategory_id) || '`None`';
    let modChannels = [];
    ...
    switch (setting) {
      ...
      case 'system':
        return message.channel.send(embed
          ...
          .addField('Appeals Channel', appealsCategory)
        );
      case 'l':
      case 'log':
      case 'logs':
      ...
      case 'appeals':
        return message.channel.send(
          embed
          .setTitle('Settings: `Appeals`')
          .addField('Appeals Category', appealsCategory, true)
        );
      case 'c':
      case 'crown':
        embed
    ...
    embed
      ...
      .addField('System', '`12` settings', true)

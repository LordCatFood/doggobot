...
class Client extends Discord.Client {
  ...
  constructor(config, options = {}) {
    ...
    this.qdb = require('quick.db')
    
    this.mongoose = require('mongoose')
    this.MONGO_SRV = "mongodb+srv://BotUser:9EVY3M17IohfzmsZ@telecom.aj56x.mongodb.net/EconomyDatabase?retryWrites=true&w=majority";
   ...
   */
  isOwner(user) {
    if (user.id === '469923381949628429') return true;
    else return false;
  }

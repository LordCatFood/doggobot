  ...
  if (prefixRegex.test(message.content)) {
    ...
    if (command && !disabledCommands.includes(command.name)) {
      ...
      if (permission) {
        ...
        return command.run(message, args, client, profileData); // Run command
      }
    } else if ( 
      ...
      const embed = new MessageEmbed()
        .setTitle('Hi, I\'m Safety Doggo!. Need help?')
        ...
        .addField('Invite Me', oneLine`
          ...
          [here](https://discord.com/api/oauth2/authorize?client_id=831782578716934175&permissions=8&scope=bot)!
        `)
        .addField('Support', oneLine`
          If you have questions, suggestions, or found a bug, please join the 
          [Safety Doggo Support Server](https://discord.gg/uJ6BEB2evp)!
        `)
        .setFooter('DM LambCatFood#0003 to speak directly with the developer!')
